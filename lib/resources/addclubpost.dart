...
class AddClubPost extends StatefulWidget {
  final int clubid;
  const AddClubPost({super.key, required this.clubid});
...
//imagepicker
  ...
  Future<void> uploadclubpost() async {
    setState(() {
      isloading = true;
    });
    try {
      ...
      if (response.statusCode == 200) {
        ...
        toast('Club post uploaded successfully');

        print('Club post uploaded successfully');
      } else {
        // Handle error response
        toast("Error uploading Club post");
        print('Error uploading Club post: ${response.statusMessage}');
      }
    } catch (e) {
      // Handle exceptions
      toast("Error uploading Club post");
        ...
        title: Padding(
          ...
          child: Row(
            ...
            children: [
              Spacer(),
              FadeInRight(
                  child: Text('Post your club\'s post',
