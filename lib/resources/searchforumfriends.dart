...
class GetForumPeople extends StatefulWidget {
  const GetForumPeople({super.key});

  @override
  State<GetForumPeople> createState() => _GetForumPeopleState();
}

class _GetForumPeopleState extends State<GetForumPeople> {
  List people = [
    "Joel",
    "Davis",
    "Peris",
